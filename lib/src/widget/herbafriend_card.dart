        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.green,
              borderRadius: BorderRadius.only(topLeft: Radius.circular(75.0), bottomLeft: Radius.circular(75.0), topRight: Radius.circular(75.0), bottomRight: Radius.circular(75.0)),
            ),
            child: ListView(
              primary: false,
